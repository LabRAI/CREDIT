...
class GraphSAGE(nn.Module):
    """
    GraphSAGE backbone for graph classification.
    """
    ...
    def __init__(self, num_classes=3, embedding_dim=128):
        ...
        self.conv1 = SAGEConv(in_channels=-1, out_channels=hidden)
        self.conv2 = SAGEConv(in_channels=hidden, out_channels=hidden)
